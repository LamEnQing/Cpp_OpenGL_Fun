...
namespace OpenGLFun {
	struct Model {
		...
		Model& Draw2D(unsigned int& shaderProgram, glm::mat4& transformMtx, unsigned int textureId, Vec2f uvDimensions = { 1.0f, 1.0f }, Vec2f uvOffsetPos = { 0.0f, 0.0f }, Vec4f tintColor = Vec4f(1.0f));
